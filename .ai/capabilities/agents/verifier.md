...
id: verifier
name: verifier
purpose: 'Validates completed work. Use after tasks are marked done to confirm implementations are functional and meet project standards.'
when_to_delegate:
...
report_format: 'Markdown report with Passed, Failed, Issues found, and Recommendations sections'
tool_limits:
