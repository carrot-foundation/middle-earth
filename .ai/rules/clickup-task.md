---
id: clickup-task
intent: 'ClickUp task creation and refinement standards'
scope:
  - '*'
requirements:
  - 'Set Category, Scope, Priority, and Effort metadata'
  - 'Include testable Definition of Done items'
  - 'Challenge scope aggressively; suggest splits for large tasks'
anti_patterns:
  - 'Vague value delivery statements'
  - 'Tasks with effort >= 5 without split suggestion'
  - 'TL;DR that just restates the title'
---
