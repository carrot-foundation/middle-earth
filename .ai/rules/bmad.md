---
id: bmad
intent: 'BMAD tool/output split and per-app artifact convention for Middle Earth'
scope:
  - '_bmad/**'
  - '_bmad-output/**'
  - 'apps/*/_bmad-output/**'
requirements:
  - 'App-scoped BMAD artifacts live under apps/<app>/_bmad-output/, never at repo root'
  - 'Each _bmad-output uses five buckets: project-context.md + brainstorming/ planning-artifacts/ implementation-artifacts/ research/ notes/'
  - 'Only _bmad/custom/ and _bmad-output/ are team-shared; the rest of _bmad/ is per-machine scaffolding'
  - 'Regenerate apps/<app>/_bmad-output/project-context.md via bmad-generate-project-context when the app scope or stack shifts'
anti_patterns:
  - 'Dropping app-level BMAD artifacts at the repo root instead of apps/<app>/_bmad-output/'
  - 'Editing under _bmad/ outside _bmad/custom/ (wiped on reinstall)'
  - 'Leaving a stale project-context.md after an epic ships or the stack changes'
  - 'Committing real PII or real person names into BMAD artifacts'
---
